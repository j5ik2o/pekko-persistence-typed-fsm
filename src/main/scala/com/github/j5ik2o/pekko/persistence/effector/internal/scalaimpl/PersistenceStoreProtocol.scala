...
/**
 * Protocol for persistence store operations.
 * This object defines the messages used for communication between the persistence effector and the persistence store.
 */
private[effector] object PersistenceStoreProtocol {
   ...
   * @param replyTo Actor reference to send the reply to
   * @tparam S Type of state
   * @tparam E Type of event
   */
   ...
   *
   * @param maxSequenceNumber Maximum sequence number of snapshots to delete
   * @param replyTo Actor reference to send the reply to
   * @tparam S Type of state
   * @tparam E Type of event
   */
   ...
   *
   * @param snapshot Snapshot that failed to persist
   ...
   *
   * @param maxSequenceNumber Maximum sequence number of snapshots that failed to delete
   * @param cause Cause of the failure
   * @tparam S Type of state
   * @tparam E Type of event
   */
   ...
   *
   * @param state Recovered state
   * @param sequenceNr Sequence number of the last recovered event
   * @tparam S Type of state
   */
