...
trait MessageProtocol[S, E] {
  ...
  /**
   * Type of message used for communication. Must be a matchable type to support pattern matching.
   */
   ...
   *
   * @return
   *   MessageConverter instance for converting between domain events/states and messages
   */
