...
trait MessageConverter[S, E, M] {
   ...
   * @return Message containing the events
   */
   ...
   * @return Message containing the state
   */
   ...
   *
   * @param maxSequenceNumber Maximum sequence number of deleted snapshots
   * @return Message containing the maximum sequence number
   */
   ...
   * @return Option containing the events, or None if the message doesn't contain events
   */
   ...
   *
   * @param message Message to extract from
   * @return Option containing the state, or None if the message doesn't contain a snapshot
   */
   ...
   *
   * @param message Message to extract from
   * @return Option containing the state, or None if the message doesn't contain a recovered state
   */
   ...
   *
   * @param message Message to extract from
   * @return Option containing the maximum sequence number, or None if the message doesn't contain deleted snapshots information
   */
...
object MessageConverter {
   ...
   *
   * @param wrapPersistedEvents Function to wrap persisted events
   * @param wrapPersistedState Function to wrap persisted state
   * @param wrapRecoveredState Function to wrap recovered state
   * @param wrapDeleteSnapshots Function to wrap deleted snapshots information
   * @tparam S Type of state
   * @tparam E Type of event
   * @tparam M Type of message
   ...
   * @tparam E Type of event
   * @tparam M Type of message
   * @return Default MessageConverter instance
   */
